        ...
        <div>
            ...
            <div class="relative">
                <input type="password"
                       ...
                       placeholder="{{ isset($user)
                            ...
                            : 'Minimal 8 karakter' }}"
                       class="w-full rounded-lg border px-4 py-2.5 pr-12 text-sm outline-none transition
                            @error('password')
                                border-red-500 focus:border-red-500 focus:ring-2 focus:ring-red-200
                            @else
                                border-slate-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200
                ...
                <button type="button"
                        class="toggle-password absolute inset-y-0 right-0 flex w-12 items-center justify-center text-slate-500 transition hover:text-slate-700 focus:outline-none"
            ...
            @if (isset($user))
                <p class="mt-2 text-xs text-slate-500">
                    Kosongkan password apabila tidak ingin mengubahnya.
                </p>
            @else
                <p class="mt-2 text-xs text-slate-500">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            /**
             * Memasang event pada seluruh tombol lihat password.
             */
