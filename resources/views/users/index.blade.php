        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Kelola akun kepala gudang dan staff gudang.
                </p>
            </div>
                    ...
                    <div>
                        ...
                        <select id="role"
                            ...
                            <option value="kepala_gudang"
                                @selected($role === 'kepala_gudang')>
                                Kepala Gudang
                            </option>

                            <option value="staff_gudang"
                                @selected($role === 'staff_gudang')>
                                Staff Gudang
                            </option>
                        </select>
                    </div>
                            ...
                            <tr>
                                <td colspan="6"
                                    ...
                                    <p class="mt-1 text-sm text-slate-400">
                                        Tambahkan pengguna atau ubah filter.
                                    </p>
                                </td>
                            </tr>
                        @endforelse
