            ...
            <div class="border-b border-slate-200 p-5">
                <form method="GET"
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <input type="text"
                               ...
                               name="search"
                               value="{{ $search }}"
                               placeholder="Cari nomor transaksi, supplier, atau petugas..."
                ...
                @if ($date)
                    <div class="mt-4 rounded-lg border border-blue-100 bg-blue-50 px-4 py-3 text-sm text-blue-700">
                        Menampilkan transaksi barang masuk pada tanggal
                            ...
                            <tr class="transition hover:bg-slate-50">
                                ...
                                <td class="whitespace-nowrap px-5 py-4 text-center text-sm text-slate-600">
                                    <p class="font-semibold text-slate-800">
                                        {{ number_format($receipt->details_count) }}
                                        jenis
                                    </p>

                                    <p class="mt-1 text-xs text-slate-500">
                                        {{ number_format(
                                            $receipt->details_sum_quantity ?? 0
                                        ) }}
                                        unit masuk
                                    </p>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="6"
                                    ...
                                    <i class="bi bi-box-arrow-in-down text-4xl text-slate-300"></i>
                                    ...
                                    <p class="mt-1 text-sm text-slate-400">
                                        Tambahkan transaksi penerimaan barang dari supplier.
                                    </p>
                                </td>
                            </tr>
                        @endforelse
