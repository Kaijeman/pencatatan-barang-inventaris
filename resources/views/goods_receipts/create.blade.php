    ...
    <div class="mx-auto max-w-6xl space-y-6">
        ...
        <form method="POST"
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="border-b border-slate-200">
                                ...
                                <th class="w-40 px-3 py-3 text-left text-xs font-semibold uppercase text-slate-500">
                                    Jumlah
                                </th>

                                <th class="w-64 px-3 py-3 text-left text-xs font-semibold uppercase text-slate-500">
                                    Harga Beli
                                </th>
                                ...
                                <tr class="item-row border-b border-slate-100">
                                    ...
                                    <td class="px-3 py-4">
                                        <input type="number"
                                               ...
                                               min="0"
                                               step="0.01"
                                               class="price-input w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm">
            ...
            <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                ...
                <button type="submit"
                        @disabled($suppliers->isEmpty() || $items->isEmpty())
