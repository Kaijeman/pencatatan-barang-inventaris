    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Rekap penerimaan barang dari supplier berdasarkan periode.
                </p>
            </div>
        ...
        <div class="overflow-hidden rounded-xl bg-white shadow-sm">
            ...
            <div class="border-b border-slate-200 p-5">
                <form method="GET"
                      action="{{ route('reports.goods-receipts') }}"
                      class="grid grid-cols-1 gap-4 xl:grid-cols-6 xl:items-end">
                    ...
                    <div class="xl:col-span-2">
                        ...
                        <input type="text"
                               ...
                               placeholder="Cari nomor, supplier, barang, atau petugas..."
                            ...
                            <tr>
                                <td colspan="7"
                                    ...
                                    <p class="mt-3 font-medium text-slate-600">
                                        Tidak ada transaksi barang masuk yang sesuai.
                                    </p>
